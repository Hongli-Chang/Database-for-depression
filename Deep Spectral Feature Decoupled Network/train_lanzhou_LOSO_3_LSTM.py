...
for n in range(53):
    ...
    WEIGHTS_PATH = r'/hdd/changhongli/Anxiety-AAL/LSTM/LOSO3_LSTM/%s.h5' % (SUB[n])
...
WEIGHTS_PATH1 = r'/hdd/changhongli/Anxiety-AAL/LSTM/LOSO3_LSTM/'
...
txtName = '/hdd/changhongli/Anxiety-AAL/LSTM/LOSO3_LSTM/'
