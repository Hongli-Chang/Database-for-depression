...
def train(save_root_path):
    ...
    savemat('/hdd/changhongli/Anxiety-AAL/results/LOSO_lanzhou128/lanzhou128_LOSO.mat', {'Val_f': Val_f, 'all_sub_acc': all_sub_acc,'Test_Y':Test_Y, 'Probs':Probs, 'acc_mean':acc_mean,'acc_std':acc_std})
    return
...
if __name__ == "__main__":
    ...
    try:
        save_root_path = '/hdd/changhongli/Anxiety-AAL/results/LOSO_lanzhou128/'
