...
class Reader(threading.Thread):
    ...
    def __init__(self, x_train, y_train,ratio_subset = 1., rng_seed=123, n_nearby=128, batch_size=32, center_pad=True, valid_fold=None):
        """
        ...
        #self.dim_channel = len(x_train[0][0][0])
        ...
        self.shuffle_index = list(range(len(self.x_train)))
...
if __name__ == '__main__':
    ...
    valid_folds = [2]
    rng_seed = 123
    x_train = numpy.zeros((120, 1500, 132, 1))
