...
from data.gendata_seed_grouped_classes_LSTM_lanzhou3chan_1 import gen_raw_data
...
def train(path,save_root_path):
    ...
    train_X, train_y_a, test_X, test_y_a, train_y_c, test_y_c, ATTR_NUM, CLASS_NUM, input_shape, lambda_mat, prior_list = gen_raw_data(path)
    ...
    for i_step in range(n_step):
        ...
        GAN_phase_1_task.train_on_batch(x_batch,
        ...
        if acc >= 0.5:
            ...
            if acc >= max(ACC):
                ...
                write_path1 = '%s_%s_data_phase1_acc_%.4f.h5' % (batch_size, i_step, acc)
...
if __name__ == "__main__":
    ...
    try:
        path = "/redhdd/changhongli/Anxiety-AAL/data/cross5chan3/LSTM3_1.mat"
        save_root_path = '/redhdd/changhongli/Anxiety-AAL/results/lanzhou3chan1/1/'
