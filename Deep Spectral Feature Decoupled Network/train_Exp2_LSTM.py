...
p_dir = '/hdd/changhongli/Anxiety-AAL/LSTM/EXP2/'
all_sub_acc = []
all_c_matrix = []
Test_Y = []
Probs = []
...
with open(dataDir) as f:
    ...
    for l in lines:
        ...
        WEIGHTS_PATH = r'/hdd/changhongli/Anxiety-AAL/LSTM/EXP2/%s.h5' % (subject)
    ...
    WEIGHTS_PATH1 = r'/hdd/changhongli/Anxiety-AAL/LSTM/EXP2/'
    ...
    txtName = '/hdd/changhongli/Anxiety-AAL/LSTM/EXP2/'
